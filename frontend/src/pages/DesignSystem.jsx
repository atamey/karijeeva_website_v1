    ...
    <>
      ...
      <section className="bg-brand-obsidian text-brand-bone min-h-screen">
        <div className="max-w-6xl mx-auto px-6 lg:px-10 py-24">
          <p className="eyebrow text-brand-gold tracking-[0.35em]">Liquid Gold Noir</p>
          <h1 className="font-display text-[clamp(2.5rem,6vw,4.5rem)] text-brand-bone mt-4" style={{ fontVariationSettings: "'opsz' 144, 'SOFT' 0" }}>
            Design system
          </h1>
          ...
          {/* Palette */}
          <div className="mt-20">
            <p className="eyebrow text-brand-gold tracking-[0.35em] mb-6">Palette</p>
          ...
          {/* Typography */}
          <div className="mt-24">
            <p className="eyebrow text-brand-gold tracking-[0.35em] mb-6">Typography — a 2-font system</p>
            <div className="space-y-10" data-testid="ds-typography">
              <div>
                <p className="eyebrow eyebrow-sm text-brand-gold mb-3">Display · Fraunces (opsz 144 · SOFT 0 · WONK 0)</p>
                <p className="font-display text-[clamp(3rem,7vw,5.5rem)] text-brand-bone leading-[1.02] tracking-[-0.02em]" style={{ fontVariationSettings: "'opsz' 144, 'SOFT' 0, 'WONK' 0" }}>
                  Pressed cold. Pressed patient.
                </p>
              </div>
              <div>
                <p className="eyebrow eyebrow-sm text-brand-gold mb-3">Display · pull-quote scale (upright, no italic)</p>
                <p className="display-quote text-brand-bone/90 max-w-[42ch]">
                  Nothing more than a coconut, a slow press, and a sealed bottle.
                </p>
              </div>
              <div>
                <p className="eyebrow eyebrow-sm text-brand-gold mb-3">Body · Inter Tight (300–700)</p>
                <p className="font-body text-brand-bone/80 text-base leading-[1.7] max-w-[62ch]">
                  Inter Tight carries every paragraph on the site — a narrower, more editorial cut of Inter.
                  Paired with upright Fraunces for every headline, every pull quote, every roman numeral.
                  Two fonts. No italic. Maximum restraint.
                </p>
              </div>
              <div>
                <p className="eyebrow eyebrow-sm text-brand-gold mb-3">Eyebrow · Inter Tight uppercase · tracking 0.18em</p>
                <p className="eyebrow text-brand-gold">This is an eyebrow label</p>
                <p className="eyebrow eyebrow-lg text-brand-gold-deep mt-2">Larger eyebrow</p>
              </div>
            </div>
          </div>
          ...
          {/* Buttons */}
          <div className="mt-24">
            <p className="eyebrow text-brand-gold tracking-[0.35em] mb-6">Buttons</p>
          ...
          {/* Pillar pattern */}
          <div className="mt-24">
            <p className="eyebrow text-brand-gold tracking-[0.35em] mb-6">Non-negotiables pattern</p>
            <ol className="divide-y divide-brand-gold/15 border-y border-brand-gold/15 max-w-3xl" data-testid="ds-pillars">
              {["Premium","Handpicked","Cold-Pressed","Clean & Hygienic","No Adulteration"].map((label, i) => (
                <li key={label} className="py-6 grid grid-cols-[60px_1fr] gap-6 items-baseline">
                  <span className="font-display text-brand-gold text-3xl" style={{ fontVariationSettings: "'opsz' 144, 'SOFT' 0" }}>{["I","II","III","IV","V"][i]}</span>
          ...
          {/* Film beat preview */}
          <div className="mt-24">
            <p className="eyebrow text-brand-gold tracking-[0.35em] mb-6">Scroll film beat</p>
            <div className="relative aspect-[21/9] overflow-hidden rounded-lg border border-brand-gold/25" data-testid="ds-beat">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <p className="eyebrow text-brand-gold text-[11px] tracking-[0.4em] mb-3">Act 4 · Cold-Pressed</p>
                <h3 className="font-display text-[clamp(1.8rem,4vw,3rem)] text-brand-bone leading-[1.05]" style={{ fontVariationSettings: "'opsz' 144, 'SOFT' 0" }}>
                  Pressed cold. Pressed patient.
                </h3>
                <p className="font-display text-brand-bone/80 mt-2">No heat. No haste. No compromise.</p>
              </div>
            </div>
          </div>
